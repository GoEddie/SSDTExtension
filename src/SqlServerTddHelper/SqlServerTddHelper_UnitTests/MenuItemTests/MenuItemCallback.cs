...
using GoEddieUk.SqlServerTddHelper;

namespace SqlServerTddHelper_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SqlServerTddHelperPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(GoEddieUk.SqlServerTddHelper.GuidList.guidSqlServerTddHelperCmdSet, (int)GoEddieUk.SqlServerTddHelper.PkgCmdIDList.cmdidGEUKDeployFile);
